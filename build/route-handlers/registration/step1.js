...
function step1(req, res) {
    ...
    (0, corsMiddleWare_1.default)(req, res, function (req, res) {
        ...
        req.on("end", function () { return __awaiter(_this, void 0, void 0, function () {
            var data, _a, firstname, lastname, mail, username, birthday, sex, password, age, hashedPass, User, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        res.setHeader("Set-Cookie", ["userid=".concat(User.id, ";path=/;HttpOnly;")]);
                        return [3 /*break*/, 5];
                    case 4:
                        error_1 = _b.sent();
                        success = false;
