...
import createSessionCookie from "../../lib/utilitys/createSessionCookie";
    ...
    (req, res) => {
      ...
      req
        ...
        .on("end", async () => {
          ...
          console.log(bodyObj);
          if (
            parseInt(bodyObj.happinessLevel) > 5 ||
        ...
        */
          ...
          try {
            ...
            const newSession = await createSession(newMentalProf.userID);
            res.setHeader("Set-Cookie", createSessionCookie(newSession.id));
